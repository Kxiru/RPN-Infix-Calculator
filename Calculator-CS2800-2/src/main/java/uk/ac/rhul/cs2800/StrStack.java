...
public class StrStack {
  ...
  /**
   * The peek() method returns the element at the top of the stack without removing it from the
   * stack.
   * 
   * @return The element at the top of the stack.
   * @throws BadTypeException Throws when the Type is bad.
   */
  public String peek() throws BadTypeException {
    if (this.isEmpty()) {
      throw new EmptyStackException();
    } else {
      Entry entry = strStack.peek();
      return entry.getString();
    }
  }
}
